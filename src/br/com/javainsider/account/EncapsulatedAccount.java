...
public class EncapsulatedAccount {
   ...
   void deposit(double amount) {
      ...
      balance += amount;
      System.out.println(
            "R$" + String.format("%.2f", amount) + " foram adicionados ao saldo: R$" + String.format("%.2f", balance));
   }
   ...
   boolean withdraw(double amount) {
      ...
      balance -= amount;
      System.out.println(
            "R$" + String.format("%.2f", amount) + " foram retirados do saldo: R$" + String.format("%.2f", balance));
      return true;
   }
